...
class SpeechToTextAgent:
    ...
    def transcribe(self, audio_path):
        ...
        Returns a dict: {"text", "lang_code", "lang_name"}
        """
        ...
        return {
            ...
            "lang_name": detected_name
        }


if __name__ == "__main__":
    agent = SpeechToTextAgent(model_size="base")  # "base" is much faster than "medium" for testing

    audio_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), "audio_samples", "MalaySample.mp4")
